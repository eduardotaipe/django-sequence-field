...
SEQUENCE_FIELD_DEFAULT_NAME = getattr(
    settings, "SEQUENCE_FIELD_DEFAULT_NAME", constants.SEQUENCE_DEFAULT_NAME
)

SEQUENCE_FIELD_DEFAULT_VALUE = getattr(
    settings, "SEQUENCE_FIELD_DEFAULT_VALUE", constants.SEQUENCE_DEFAULT_VALUE
)

SEQUENCE_FIELD_ADMIN = getattr(
    settings, "SEQUENCE_FIELD_ADMIN", constants.SEQUENCE_FIELD_ADMIN
)
...
SEQUENCE_FIELD_DEFAULT_PATTERN = getattr(
    settings, "SEQUENCE_FIELD_DEFAULT_PATTERN", constants.SEQUENCE_FIELD_DEFAULT_PATTERN
)
