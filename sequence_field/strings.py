...
SEQUENCE_FIELD_MISSING_KEY = _("The key parameter is mandatory and is missing")
SEQUENCE_FIELD_PATTERN_MISMATCH = _("The value does not match the specified pattern")
SEQUENCE_FIELD_KEY_MISMATCH = _(
    "The key '%(key)s' does not match any of the existing " "sequence model objects"
)
